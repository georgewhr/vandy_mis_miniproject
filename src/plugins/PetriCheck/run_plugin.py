"""
This script is called by the plugin-wrapper, PetriCheck.js, which passes down the
...
from PetriCheck import PetriCheck
...
plugin = PetriCheck(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
